...
type EditProspectWithDataProps = {
	uid: IUser['_id'];
	onReload: () => void;
};

const EditProspectWithData = ({ uid, onReload, ...props }: EditProspectWithDataProps): ReactElement => {
	...
	return <EditProspect data={data?.user} roles={roleData?.roles} onReload={onReload} {...props} />;
};

export default EditProspectWithData;
